...
public final class PlaybackStats {
   ...
   * after seek.
   */
  //MINH [get total stall duration to PlayerActivity.java] - MOD - S
  public final int totalRebufferCount;
//  public static int totalRebufferCount;
  //MINH [get total stall duration to PlayerActivity.java] - MOD - E
  /**
  ...
  //MINH [get total stall duration to PlayerActivity.java] - MOD - S
  private long[] playbackStateDurationsMs;
  //MINH [get total stall duration to PlayerActivity.java] - MOD - E
...
//  public static long getPlaybackStateDurationMs(@PlaybackState int playbackState) {
    //MINH [get total stall duration to PlayerActivity.java] - MOD - E
...
//  public static long getTotalRebufferTimeMs() {
    //MINH [get total stall duration to PlayerActivity.java] - MOD - E
