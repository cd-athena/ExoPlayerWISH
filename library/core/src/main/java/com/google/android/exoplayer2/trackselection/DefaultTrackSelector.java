 ...
 */
//[MINH] Default ABR algorithm
public class DefaultTrackSelector extends MappingTrackSelector {
  private static final String MINH_TAG = "MINH";
  /**
...
//    this(context, new MinhTrackSelection.Factory());
    Log.i("[MINH]", "PlayerManager - 2");
  }
...
//	Log.i(MINH_TAG, "Set enableAdaptiveTracks. EnableAdapation? " + enableAdaptiveTrackSelection);
        @Nullable
  ...
  protected TrackSelection.Definition selectVideoTrack(
    ...
    if (!params.forceHighestSupportedBitrate
        ...
        && enableAdaptiveTrackSelection) {
      Log.i(MINH_TAG, "Default selectiVideoTrack()");
      definition =
    ...
    Log.i(MINH_TAG, "definition: " + definition);
    return definition;
  }
