...
public class AnalyticsCollector
  ...
  private static int numOfStalls = -1;
  private static long totalStallDuration = 0;
  private static long startupDuration;
  private static long startupTimeStamp;
  private static List<Long> start_stall_timestampMs = new ArrayList<>();
  private static List<Long> instant_stall_duration = new ArrayList<>();
  ...
  public static int getNumOfStalls(){
    return numOfStalls;
  }
  public static long getStallDuration() {
    return totalStallDuration;
  }
  public static long getStartupDuration(){ return startupDuration; }
