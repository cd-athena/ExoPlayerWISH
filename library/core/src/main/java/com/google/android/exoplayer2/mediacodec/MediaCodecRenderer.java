...
public abstract class MediaCodecRenderer extends BaseRenderer {
  ...
  public MediaCodecRenderer(
    ...
    outputBufferInfo = new MediaCodec.BufferInfo(); // Minh: it contains the frame's info.
    operatingRate = 1f;
...
//    Log.i("MINH", "*********************Call onQueueInputBuffer from MediaCodecRenderer");
  ...
  private boolean drainOutputBuffer(long positionUs, long elapsedRealtimeUs)
    ...
    if (codecNeedsEosOutputExceptionWorkaround && codecReceivedEos) {
      ...
      // MINH [Get access to the downloaded segments/frames] - ADD - S
//      Log.i("MINH", "999999999999999999 call processOutputBuffer from drainOutputBuffer of MediaCodecRenderer - 1");
      // MINH [Get access to the downloaded segments/frames] - ADD - E
      processedOutputBuffer =
          processOutputBuffer(
              positionUs,
