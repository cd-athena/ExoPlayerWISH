...
/* package */ class PlayerManager implements EventListener, SessionAvailabilityListener {
  ...
  public PlayerManager(
    ...
    // MINH Declare trackSelector to be used
    Log.i("[MINH]", "PlayerManager - 1");
    trackSelector = new DefaultTrackSelector(context);
    exoPlayer = new SimpleExoPlayer.Builder(context).setTrackSelector(trackSelector).build();
    // MINH -S
//    trackSelector = DefaultTrackSelector(new MinhTrackSelectionFactory());
//    exoPlayer = new SimpleExoPlayer.Builder(context).setTrackSelector(trackSelector).build();
    // MINH -E
